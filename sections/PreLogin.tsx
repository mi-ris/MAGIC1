...
const PreLogin: React.FC<Props> = ({ onStart }) => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center py-8 px-6 overflow-hidden">
      ...
      {/* CARTAS CENTRADAS - DIBUJOS PEQUEÑOS (RESTAURADOS) */}
      <div className="flex gap-4 sm:gap-8 items-center justify-center mb-16 z-10">
        {[
            ...
            <div 
                ...
                style={{ animation: `float ${3 + idx * 0.4}s ease-in-out infinite` }}
            >
                <div className="flex-1 flex items-center justify-center">
                    {/* El dibujo vuelve a ser pequeño como al principio */}
      ...
      <div className="flex flex-col items-center w-full max-w-sm z-20">
        <button 
          onClick={onStart}
          className="btn-magic-pop bg-orange-500 hover:bg-orange-600 text-white text-3xl sm:text-4xl px-16 py-6 rounded-full font-magic uppercase tracking-widest border-4 border-white shadow-[0_12px_0_#c2410c] active:shadow-none active:translate-y-2 flex items-center gap-4"
        >
          COMENZAR 🚀
        </button>
      </div>
